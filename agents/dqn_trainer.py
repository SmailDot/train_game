...
from agents.dqn_agent import DQNAgent, ReplayMemory, Transition
...
class DQNTrainer:
    ...
    def train(
        ...
        for t in range(total_timesteps):
            ...
            loss, q_values, expected_q_values = self.dqn_update()
            ...
            if t > 0 and t % log_interval == 0:
                ...
                if it % 100 == 0:
                    cp = self.save(it)
                    print(f"Saved DQN checkpoint {cp}")
